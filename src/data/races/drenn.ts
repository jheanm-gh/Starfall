...
export const DRENN_HEROES: HeroDefinition[] = [
  {
    ...
    baseStats: { hull: 114, atk: 51, def: 36, spd: 35, foc: 34, res: 28 },
    growth: { hull: 9.6, atk: 4.9, def: 2.8, spd: 1.1, foc: 2, res: 1.7 },
  ...
  },
  {
    ...
    baseStats: { hull: 118, atk: 44, def: 36, spd: 33, foc: 31, res: 28 },
    growth: { hull: 10.2, atk: 4.2, def: 3, spd: 1.1, foc: 1.8, res: 1.6 },
  ...
  },
  {
    ...
    baseStats: { hull: 90, atk: 44, def: 29, spd: 30, foc: 30, res: 22 },
  ...
  },
  {
    ...
    baseStats: { hull: 110, atk: 52, def: 35, spd: 38, foc: 35, res: 24 },
    growth: { hull: 9.5, atk: 5.1, def: 2.7, spd: 1.1, foc: 2, res: 1.3 },
  ...
  },
  {
    ...
    baseStats: { hull: 135, atk: 58, def: 44, spd: 36, foc: 39, res: 31 },
    growth: { hull: 11.9, atk: 5.6, def: 3.2, spd: 1.1, foc: 2.3, res: 1.9 },
    skills: ['drenn_hammerfall', 'drenn_bloodprice', 'drenn_overdrive', 'drenn_breachbolt'],
    awakenedPassive: 'drenn_awk_grind',
  },
  {
    ...
    baseStats: { hull: 102, atk: 50, def: 32, spd: 32, foc: 36, res: 25 },
    growth: { hull: 8.7, atk: 4.8, def: 2.5, spd: 1, foc: 2.2, res: 1.5 },
  ...
  },
  {
    ...
    baseStats: { hull: 130, atk: 51, def: 41, spd: 33, foc: 35, res: 33 },
    growth: { hull: 11.6, atk: 4.8, def: 3.3, spd: 1.1, foc: 2.2, res: 2 },
  ...
  },
  {
    ...
    baseStats: { hull: 129, atk: 60, def: 38, spd: 36, foc: 38, res: 27 },
    growth: { hull: 11.1, atk: 5.7, def: 2.9, spd: 1, foc: 2.3, res: 1.7 },
    skills: ['drenn_overdrive', 'drenn_hammerfall', 'drenn_feedgrind', 'drenn_furnace'],
    awakenedPassive: 'drenn_awk_feed',
  },
  {
    ...
    baseStats: { hull: 117, atk: 58, def: 39, spd: 32, foc: 39, res: 29 },
    growth: { hull: 10.5, atk: 5.1, def: 2.9, spd: 0.9, foc: 2.3, res: 1.6 },
    skills: ['drenn_breachbolt', 'drenn_overdrive', 'drenn_scrapstorm', 'drenn_scrapline'],
    awakenedPassive: 'drenn_awk_pierce',
  },
  {
    ...
    baseStats: { hull: 153, atk: 80, def: 46, spd: 46, foc: 49, res: 34 },
    growth: { hull: 13.1, atk: 7.1, def: 3.5, spd: 1.4, foc: 3, res: 2 },
  ...
  },
  {
    ...
    baseStats: { hull: 139, atk: 53, def: 48, spd: 30, foc: 36, res: 34 },
    growth: { hull: 12.7, atk: 4.9, def: 3.4, spd: 1, foc: 2.3, res: 2.3 },
  ...
  },
  {
    ...
    skills: ['drenn_overdrive', 'drenn_breachbolt', 'drenn_scrapline', 'drenn_lastshift'],
  ...
  },
  {
    ...
    baseStats: { hull: 186, atk: 82, def: 59, spd: 44, foc: 51, res: 44 },
    growth: { hull: 16, atk: 7.6, def: 4.1, spd: 1.3, foc: 3, res: 2.8 },
  ...
  },
  {
    ...
    baseStats: { hull: 200, atk: 95, def: 64, spd: 51, foc: 59, res: 47 },
    growth: { hull: 17.5, atk: 8.4, def: 4.2, spd: 1.6, foc: 3.5, res: 2.9 },
    skills: ['drenn_overdrive', 'drenn_lastshift', 'drenn_scrapline', 'drenn_hullborn'],
    awakenedPassive: 'drenn_awk_stand',
  },
];
