...
export const RECLAIMED_HEROES: HeroDefinition[] = [
  {
    ...
    baseStats: { hull: 128, atk: 44, def: 44, spd: 42, foc: 37, res: 42 },
    growth: { hull: 11.3, atk: 4.2, def: 3.5, spd: 1.4, foc: 2.3, res: 2.8 },
  ...
  },
  {
    ...
    baseStats: { hull: 118, atk: 47, def: 39, spd: 45, foc: 41, res: 39 },
    growth: { hull: 9.6, atk: 4.5, def: 2.9, spd: 1.5, foc: 2.5, res: 2.5 },
  ...
  },
  {
    ...
    baseStats: { hull: 150, atk: 45, def: 52, spd: 40, foc: 36, res: 46 },
    growth: { hull: 13, atk: 4.3, def: 4.1, spd: 1.3, foc: 2.1, res: 3 },
  ...
  },
  {
    ...
    baseStats: { hull: 117, atk: 50, def: 37, spd: 46, foc: 42, res: 35 },
  ...
  },
  {
    ...
    baseStats: { hull: 116, atk: 51, def: 37, spd: 49, foc: 49, res: 37 },
  ...
  },
  {
    ...
    baseStats: { hull: 161, atk: 54, def: 54, spd: 49, foc: 50, res: 54 },
    growth: { hull: 14.6, atk: 5.2, def: 4.2, spd: 1.7, foc: 3.1, res: 3.5 },
  ...
  },
  {
    ...
    baseStats: { hull: 132, atk: 59, def: 44, spd: 50, foc: 52, res: 43 },
    growth: { hull: 11.5, atk: 5.6, def: 3.4, spd: 1.7, foc: 3.4, res: 2.7 },
  ...
  },
  {
    ...
    baseStats: { hull: 151, atk: 51, def: 47, spd: 42, foc: 42, res: 47 },
    growth: { hull: 13.1, atk: 4.9, def: 3.6, spd: 1.4, foc: 2.6, res: 3 },
  ...
  },
  {
    ...
    baseStats: { hull: 129, atk: 57, def: 40, spd: 53, foc: 49, res: 38 },
    growth: { hull: 11.3, atk: 5.5, def: 2.9, spd: 1.9, foc: 2.9, res: 2.5 },
    skills: ['reclaimed_overclock', 'reclaimed_emp', 'reclaimed_arc_welder', 'reclaimed_capacitor'],
    awakenedPassive: 'reclaimed_awk_surge',
  },
  {
    ...
    baseStats: { hull: 195, atk: 64, def: 66, spd: 46, foc: 50, res: 62 },
    growth: { hull: 16.8, atk: 6, def: 4.8, spd: 1.6, foc: 3.1, res: 4 },
  ...
  },
  {
    ...
    baseStats: { hull: 141, atk: 65, def: 46, spd: 53, foc: 57, res: 44 },
    growth: { hull: 11.8, atk: 6.1, def: 3.2, spd: 1.8, foc: 3.4, res: 2.7 },
  ...
  },
  {
    ...
    baseStats: { hull: 139, atk: 63, def: 47, spd: 47, foc: 50, res: 41 },
    growth: { hull: 12, atk: 5.9, def: 3.3, spd: 1.6, foc: 2.9, res: 2.6 },
    skills: ['reclaimed_salvage_strike', 'reclaimed_cannibalise', 'reclaimed_arc_welder', 'reclaimed_junk_wall'],
    awakenedPassive: 'reclaimed_awk_graft',
  },
  {
    ...
    baseStats: { hull: 176, atk: 67, def: 56, spd: 50, foc: 58, res: 55 },
    growth: { hull: 15.6, atk: 6.3, def: 4.2, spd: 1.6, foc: 3.5, res: 3.5 },
  ...
  },
  {
    ...
    baseStats: { hull: 162, atk: 78, def: 52, spd: 57, foc: 65, res: 47 },
    growth: { hull: 13.6, atk: 7.3, def: 3.9, spd: 1.9, foc: 3.7, res: 3 },
  ...
  },
  {
    ...
    baseStats: { hull: 188, atk: 76, def: 61, spd: 55, foc: 63, res: 59 },
