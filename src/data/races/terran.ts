...
export const TERRAN_SKILLS: SkillDefinition[] = [
  ...
  {
    id: 'terran_fade', name: 'Fade', type: 'psionic', cooldown: 3, priority: 3,
    description: 'Slips the next attack and comes back faster.',
    effects: [
      { kind: 'PRIORITY', tier: 3 },
      { kind: 'DODGE_NEXT' },
      { kind: 'STAT_MODIFY', stat: 'spd', percent: 0.35, duration: 2, target: 'self' },
    ],
  },
  {
...
export const TERRAN_HEROES: HeroDefinition[] = [
  {
    ...
    baseStats: { hull: 126, atk: 49, def: 42, spd: 49, foc: 38, res: 42 },
    growth: { hull: 10.4, atk: 4.2, def: 3.6, spd: 1.5, foc: 2.5, res: 2.9 },
  ...
  },
  {
    ...
    baseStats: { hull: 124, atk: 55, def: 40, spd: 60, foc: 55, res: 38 },
    growth: { hull: 10, atk: 5.3, def: 3, spd: 2.2, foc: 3.4, res: 2.4 },
    skills: ['terran_pulse', 'terran_jam_transmitter', 'terran_uplink', 'terran_sidearm'],
  ...
  },
  {
    ...
    baseStats: { hull: 136, atk: 62, def: 41, spd: 75, foc: 50, res: 37 },
    growth: { hull: 10.4, atk: 5.5, def: 2.9, spd: 2.8, foc: 3.2, res: 2.3 },
  ...
  },
  {
    ...
    baseStats: { hull: 112, atk: 51, def: 36, spd: 43, foc: 44, res: 31 },
    growth: { hull: 9.3, atk: 4.7, def: 3, spd: 1.4, foc: 3, res: 2.3 },
    skills: ['terran_incendiary', 'terran_cook_off', 'terran_tamp', 'terran_frag'],
  ...
  },
  {
    ...
    baseStats: { hull: 132, atk: 46, def: 49, spd: 53, foc: 40, res: 49 },
    growth: { hull: 12.3, atk: 4.2, def: 4, spd: 1.9, foc: 2.4, res: 3.3 },
  ...
  },
  {
    ...
    baseStats: { hull: 135, atk: 64, def: 47, spd: 50, foc: 53, res: 39 },
    growth: { hull: 11.1, atk: 6.2, def: 3.9, spd: 1.5, foc: 3.4, res: 2.7 },
    skills: ['terran_acid_charge', 'terran_demolition', 'terran_entrench', 'terran_frag'],
  ...
  },
  {
    ...
    baseStats: { hull: 135, atk: 61, def: 44, spd: 66, foc: 63, res: 40 },
    growth: { hull: 11.7, atk: 5.8, def: 3.6, spd: 2.5, foc: 3.8, res: 2.8 },
  ...
  },
  {
    ...
    baseStats: { hull: 140, atk: 61, def: 49, spd: 59, foc: 56, res: 46 },
    growth: { hull: 12.3, atk: 5.7, def: 3.7, spd: 2.3, foc: 3.3, res: 3 },
    skills: ['terran_pulse', 'terran_crossfire', 'terran_command_override', 'terran_overwatch'],
  ...
  },
  {
    ...
    baseStats: { hull: 144, atk: 61, def: 50, spd: 43, foc: 45, res: 45 },
    growth: { hull: 12.2, atk: 5.9, def: 3.8, spd: 1.3, foc: 2.8, res: 3.1 },
    skills: ['terran_boarding_axe', 'terran_vacuum_drill', 'terran_mag_lock', 'terran_aimed_shot'],
  ...
  },
  {
    ...
    baseStats: { hull: 149, atk: 66, def: 53, spd: 64, foc: 62, res: 46 },
    growth: { hull: 11.5, atk: 6, def: 3.8, spd: 2.4, foc: 3.5, res: 3.2 },
  ...
  },
  {
    ...
    baseStats: { hull: 161, atk: 69, def: 64, spd: 56, foc: 54, res: 56 },
    growth: { hull: 14.5, atk: 6.6, def: 4.8, spd: 2.2, foc: 3.2, res: 3.3 },
  ...
  },
  {
    ...
    baseStats: { hull: 157, atk: 85, def: 52, spd: 89, foc: 79, res: 52 },
    growth: { hull: 13.2, atk: 8.1, def: 4, spd: 3.2, foc: 4.3, res: 3.3 },
    skills: ['terran_killing_word', 'terran_silence', 'terran_fade', 'terran_deadline'],
  ...
  },
  {
    ...
    baseStats: { hull: 149, atk: 68, def: 55, spd: 64, foc: 59, res: 53 },
    growth: { hull: 12.9, atk: 6.4, def: 4, spd: 2.3, foc: 3.3, res: 3.2 },
