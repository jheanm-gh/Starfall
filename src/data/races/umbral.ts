...
export const UMBRAL_HEROES: HeroDefinition[] = [
  ...
  },
  {
    ...
    baseStats: { hull: 124, atk: 51, def: 41, spd: 64, foc: 59, res: 46 },
  ...
  },
  {
    ...
    baseStats: { hull: 122, atk: 54, def: 40, spd: 67, foc: 63, res: 49 },
    growth: { hull: 10.4, atk: 5.2, def: 3.2, spd: 2.2, foc: 3.8, res: 3.2 },
    skills: ['umbral_static_field', 'umbral_shiv', 'umbral_hollow', 'umbral_fade'],
    awakenedPassive: 'umbral_awk_erode',
  },
  {
    ...
    baseStats: { hull: 123, atk: 63, def: 42, spd: 70, foc: 60, res: 44 },
    growth: { hull: 10.5, atk: 6, def: 3.2, spd: 2.3, foc: 3.5, res: 3 },
  ...
  },
  {
    ...
    baseStats: { hull: 130, atk: 52, def: 43, spd: 63, foc: 54, res: 49 },
    growth: { hull: 11, atk: 5, def: 3.2, spd: 2.2, foc: 3.4, res: 3.2 },
  ...
  },
  {
    ...
    baseStats: { hull: 138, atk: 63, def: 47, spd: 69, foc: 66, res: 49 },
    growth: { hull: 11.6, atk: 5.9, def: 3.5, spd: 2.4, foc: 4.1, res: 3.5 },
  ...
  },
  {
    ...
    baseStats: { hull: 122, atk: 58, def: 44, spd: 66, foc: 58, res: 49 },
    growth: { hull: 10.3, atk: 5.4, def: 3.1, spd: 2.1, foc: 3.5, res: 3.1 },
  ...
  },
  {
    ...
    baseStats: { hull: 148, atk: 73, def: 50, spd: 79, foc: 73, res: 57 },
    growth: { hull: 12, atk: 7.1, def: 3.5, spd: 2.6, foc: 4.5, res: 3.9 },
  ...
  },
  {
    ...
    baseStats: { hull: 140, atk: 64, def: 47, spd: 79, foc: 64, res: 55 },
    growth: { hull: 11.8, atk: 6, def: 3.6, spd: 3, foc: 3.9, res: 3.7 },
  ...
  },
  {
    ...
    baseStats: { hull: 143, atk: 80, def: 48, spd: 80, foc: 69, res: 50 },
    growth: { hull: 11.7, atk: 7.1, def: 3.6, spd: 2.6, foc: 4.1, res: 3.2 },
    skills: ['umbral_severance', 'umbral_ghostmark', 'umbral_blindfold', 'umbral_shiv'],
    awakenedPassive: 'umbral_awk_vanish',
  },
  {
    id: 'umbral_absence', slug: 'the-absence', name: 'The Absence', race: 'umbral',
    rarity: 'epic', rosterCost: 7, damageType: 'psionic', role: 'Denial',
    baseStats: { hull: 147, atk: 81, def: 51, spd: 86, foc: 71, res: 57 },
    growth: { hull: 13, atk: 6.9, def: 3.6, spd: 3.1, foc: 4.2, res: 3.8 },
  ...
  },
  {
    ...
    baseStats: { hull: 141, atk: 81, def: 47, spd: 83, foc: 74, res: 53 },
    growth: { hull: 11.7, atk: 7, def: 3.1, spd: 3, foc: 4, res: 3.4 },
    skills: ['umbral_haze', 'umbral_shadowbleed', 'umbral_severance', 'umbral_shiv'],
    awakenedPassive: 'umbral_awk_haze',
  },
  {
