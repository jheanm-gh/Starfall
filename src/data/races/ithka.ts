...
export const ITHKA_HEROES: HeroDefinition[] = [
  ...
  },
  {
    ...
    baseStats: { hull: 118, atk: 60, def: 34, spd: 95, foc: 67, res: 42 },
    growth: { hull: 10, atk: 5.7, def: 2.8, spd: 3.5, foc: 3.8, res: 3 },
    skills: ['ithka_quill', 'ithka_mirage', 'ithka_slip', 'ithka_blindside'],
  ...
  },
  {
    ...
    baseStats: { hull: 94, atk: 59, def: 29, spd: 75, foc: 55, res: 29 },
    growth: { hull: 7, atk: 5.7, def: 2.4, spd: 2.9, foc: 3.3, res: 2.2 },
  ...
  },
  {
    ...
    baseStats: { hull: 120, atk: 60, def: 35, spd: 84, foc: 63, res: 45 },
    growth: { hull: 10, atk: 5.7, def: 2.8, spd: 3.2, foc: 3.7, res: 3 },
    skills: ['ithka_quill', 'ithka_thin_air', 'ithka_pressure_cut', 'ithka_stillness'],
  ...
  },
  {
    ...
    skills: ['ithka_hollow_strike', 'ithka_flurry', 'ithka_slip', 'ithka_blindside'],
    awakenedPassive: 'ithka_awk_tempo',
  },
  {
    ...
    baseStats: { hull: 117, atk: 67, def: 35, spd: 84, foc: 62, res: 33 },
    growth: { hull: 9.9, atk: 6.4, def: 2.7, spd: 2.9, foc: 3.5, res: 2.4 },
  ...
  },
  {
    ...
    baseStats: { hull: 121, atk: 63, def: 35, spd: 96, foc: 72, res: 45 },
    growth: { hull: 10.5, atk: 6.1, def: 2.6, spd: 3.3, foc: 3.9, res: 3.1 },
    skills: ['ithka_mirage', 'ithka_quill', 'ithka_stillness', 'ithka_flurry'],
    awakenedPassive: 'ithka_awk_evade',
  },
  {
    ...
    baseStats: { hull: 123, atk: 67, def: 38, spd: 82, foc: 62, res: 36 },
    growth: { hull: 9.9, atk: 6.3, def: 3, spd: 3, foc: 3.6, res: 2.5 },
  ...
  },
  {
    ...
    baseStats: { hull: 121, atk: 72, def: 36, spd: 94, foc: 66, res: 36 },
    growth: { hull: 10.3, atk: 6.7, def: 2.7, spd: 3.1, foc: 3.6, res: 2.5 },
  ...
  },
  {
    ...
    baseStats: { hull: 138, atk: 72, def: 45, spd: 98, foc: 75, res: 55 },
    growth: { hull: 11.2, atk: 6.9, def: 3.2, spd: 3.3, foc: 4.5, res: 3.4 },
    skills: ['ithka_mirage', 'ithka_hollow_strike', 'ithka_tempo_break', 'ithka_flurry'],
    awakenedPassive: 'ithka_awk_evade',
  },
  {
    ...
    baseStats: { hull: 127, atk: 73, def: 37, spd: 93, foc: 70, res: 43 },
    growth: { hull: 10.8, atk: 6.9, def: 2.9, spd: 3.2, foc: 3.9, res: 3.1 },
    skills: ['ithka_hollow_strike', 'ithka_pressure_cut', 'ithka_thousand', 'ithka_cull'],
    awakenedPassive: 'ithka_awk_vacuum',
  },
  {
    ...
    baseStats: { hull: 138, atk: 88, def: 42, spd: 104, foc: 77, res: 44 },
    growth: { hull: 11.6, atk: 8, def: 3.2, spd: 3.4, foc: 4.2, res: 3.1 },
  ...
  },
  {
    ...
    baseStats: { hull: 148, atk: 77, def: 45, spd: 101, foc: 80, res: 56 },
    growth: { hull: 12.9, atk: 7.3, def: 3.2, spd: 3.3, foc: 4.3, res: 3.4 },
    skills: ['ithka_mirage', 'ithka_hollow_strike', 'ithka_stillness', 'ithka_thousand'],
    awakenedPassive: 'ithka_awk_evade',
  },
  {
    ...
    baseStats: { hull: 152, atk: 93, def: 46, spd: 116, foc: 84, res: 53 },
    growth: { hull: 12.8, atk: 8.4, def: 3.4, spd: 3.6, foc: 4.4, res: 3.2 },
