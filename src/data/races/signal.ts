...
export const SIGNAL_HEROES: HeroDefinition[] = [
  {
    ...
    baseStats: { hull: 132, atk: 56, def: 42, spd: 61, foc: 62, res: 48 },
    growth: { hull: 11.3, atk: 5.1, def: 3.2, spd: 2.3, foc: 3.7, res: 3.2 },
  ...
  },
  {
    ...
    skills: ['signal_interference', 'signal_unmind', 'signal_whisper', 'signal_ion_call'],
    awakenedPassive: 'signal_awk_seize',
  },
  {
    id: 'signal_echo', slug: 'echo-node', name: 'Echo Node', race: 'signal',
    rarity: 'common', rosterCost: 1, damageType: 'psionic', role: 'Reflector',
    baseStats: { hull: 122, atk: 43, def: 40, spd: 49, foc: 50, res: 48 },
    growth: { hull: 11.1, atk: 4, def: 3.2, spd: 1.8, foc: 3, res: 3 },
  ...
  },
  {
    ...
    baseStats: { hull: 127, atk: 52, def: 40, spd: 55, foc: 57, res: 52 },
    growth: { hull: 10.6, atk: 4.8, def: 3.1, spd: 2, foc: 3.3, res: 3.3 },
  ...
  },
  {
    ...
    baseStats: { hull: 123, atk: 54, def: 41, spd: 58, foc: 60, res: 48 },
    growth: { hull: 11.1, atk: 5.2, def: 3, spd: 2.1, foc: 3.4, res: 3 },
  ...
  },
  {
    ...
    baseStats: { hull: 115, atk: 55, def: 38, spd: 54, foc: 55, res: 39 },
    growth: { hull: 9.4, atk: 5.2, def: 2.9, spd: 2.1, foc: 3.3, res: 2.7 },
    skills: ['signal_ion_call', 'signal_interference', 'signal_unmind', 'signal_chorus'],
    awakenedPassive: 'signal_awk_seize',
  },
  {
    ...
    baseStats: { hull: 142, atk: 51, def: 49, spd: 51, foc: 54, res: 53 },
    growth: { hull: 12.1, atk: 4.9, def: 3.6, spd: 1.9, foc: 3.3, res: 3.3 },
  ...
  },
  {
    ...
    baseStats: { hull: 152, atk: 70, def: 52, spd: 72, foc: 78, res: 55 },
    growth: { hull: 13.6, atk: 6.6, def: 3.4, spd: 2.6, foc: 4.1, res: 3.4 },
  ...
  },
  {
    ...
    baseStats: { hull: 147, atk: 65, def: 50, spd: 65, foc: 69, res: 56 },
    growth: { hull: 12.5, atk: 6.1, def: 3.7, spd: 2.4, foc: 3.9, res: 3.7 },
  ...
  },
  {
    ...
    skills: ['signal_null_call', 'signal_silence', 'signal_shared_pain', 'signal_whisper'],
    awakenedPassive: 'signal_awk_still',
  },
  {
  ...
  },
  {
    ...
    baseStats: { hull: 197, atk: 75, def: 69, spd: 71, foc: 79, res: 75 },
  ...
  },
  {
    ...
    baseStats: { hull: 205, atk: 98, def: 69, spd: 94, foc: 98, res: 72 },
    growth: { hull: 17.5, atk: 8.7, def: 4.8, spd: 3.1, foc: 5.3, res: 4.6 },
