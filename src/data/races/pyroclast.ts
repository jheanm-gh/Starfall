...
export const PYROCLAST_HEROES: HeroDefinition[] = [
  {
    ...
    baseStats: { hull: 118, atk: 44, def: 37, spd: 39, foc: 39, res: 33 },
    growth: { hull: 9.6, atk: 4.2, def: 3, spd: 1.1, foc: 2.6, res: 2.2 },
  ...
  },
  {
    ...
    baseStats: { hull: 121, atk: 36, def: 45, spd: 30, foc: 31, res: 34 },
  ...
  },
  {
    ...
    baseStats: { hull: 127, atk: 50, def: 39, spd: 46, foc: 46, res: 35 },
  ...
  },
  {
    ...
    baseStats: { hull: 121, atk: 53, def: 42, spd: 44, foc: 50, res: 33 },
    growth: { hull: 10.2, atk: 5, def: 3.1, spd: 1.2, foc: 2.9, res: 2.2 },
    skills: ['pyro_ignite', 'pyro_flashover', 'pyro_vent_burst', 'pyro_slag'],
    awakenedPassive: 'pyro_awk_kindle',
  },
  {
    ...
    baseStats: { hull: 130, atk: 44, def: 49, spd: 32, foc: 37, res: 39 },
    growth: { hull: 11.1, atk: 4.1, def: 3.5, spd: 1, foc: 2.2, res: 2.6 },
  ...
  },
  {
    ...
    baseStats: { hull: 122, atk: 58, def: 41, spd: 48, foc: 52, res: 34 },
    growth: { hull: 10.5, atk: 5.5, def: 3, spd: 1.3, foc: 3, res: 2 },
    skills: ['pyro_vent_burst', 'pyro_thermal_lance', 'pyro_ashfall', 'pyro_ignite'],
    awakenedPassive: 'pyro_awk_native',
  },
  {
    ...
    baseStats: { hull: 127, atk: 55, def: 42, spd: 37, foc: 46, res: 33 },
    growth: { hull: 11.1, atk: 5.1, def: 3.2, spd: 1, foc: 2.8, res: 2.2 },
  ...
  },
  {
    ...
    baseStats: { hull: 141, atk: 69, def: 52, spd: 50, foc: 60, res: 42 },
    growth: { hull: 12.4, atk: 6.1, def: 3.6, spd: 1.6, foc: 3.5, res: 2.8 },
    skills: ['pyro_ignite', 'pyro_vent_burst', 'pyro_thermal_lance', 'pyro_bloom'],
  ...
  },
  {
    ...
    baseStats: { hull: 154, atk: 54, def: 56, spd: 38, foc: 50, res: 50 },
    growth: { hull: 13.8, atk: 5.3, def: 4, spd: 1, foc: 2.8, res: 3.2 },
  ...
  },
  {
    ...
    baseStats: { hull: 125, atk: 58, def: 42, spd: 44, foc: 48, res: 36 },
    growth: { hull: 10.8, atk: 5.3, def: 3.1, spd: 1.5, foc: 3.1, res: 2.4 },
  ...
  },
  {
    ...
    baseStats: { hull: 163, atk: 75, def: 55, spd: 47, foc: 60, res: 51 },
    growth: { hull: 14.4, atk: 7.1, def: 3.9, spd: 1.4, foc: 3.6, res: 3.3 },
    skills: ['pyro_vent_burst', 'pyro_flashover', 'pyro_ignite', 'pyro_caldera'],
    awakenedPassive: 'pyro_awk_eruption',
  },
  {
    ...
    baseStats: { hull: 146, atk: 60, def: 50, spd: 37, foc: 48, res: 46 },
    growth: { hull: 12.7, atk: 5.6, def: 3.4, spd: 1.1, foc: 3.1, res: 3.1 },
  ...
  },
  {
    ...
    baseStats: { hull: 172, atk: 82, def: 56, spd: 50, foc: 66, res: 53 },
    growth: { hull: 14.9, atk: 7.6, def: 4.1, spd: 1.6, foc: 3.7, res: 3.5 },
