...
export const VANTARI_HEROES: HeroDefinition[] = [
  {
    ...
    baseStats: { hull: 130, atk: 40, def: 54, spd: 23, foc: 26, res: 36 },
    growth: { hull: 11.5, atk: 3.8, def: 4, spd: 0.8, foc: 1.8, res: 2.3 },
  ...
  },
  {
    ...
    baseStats: { hull: 123, atk: 42, def: 46, spd: 25, foc: 27, res: 30 },
  ...
  },
  {
    ...
    baseStats: { hull: 127, atk: 43, def: 48, spd: 28, foc: 34, res: 32 },
  ...
  },
  {
    ...
    baseStats: { hull: 131, atk: 45, def: 49, spd: 25, foc: 30, res: 35 },
    growth: { hull: 11.8, atk: 4.3, def: 3.5, spd: 1, foc: 2.1, res: 2.3 },
  ...
  },
  {
    ...
    baseStats: { hull: 147, atk: 44, def: 58, spd: 23, foc: 31, res: 44 },
    growth: { hull: 13.3, atk: 4.3, def: 4.3, spd: 0.9, foc: 2, res: 2.6 },
  ...
  },
  {
    ...
    baseStats: { hull: 123, atk: 48, def: 46, spd: 24, foc: 34, res: 34 },
    growth: { hull: 10.5, atk: 4.6, def: 3.4, spd: 0.9, foc: 2.2, res: 2.2 },
    skills: ['vantari_tectonic', 'vantari_gravitic_slam', 'vantari_setstance', 'vantari_mass_driver'],
  ...
  },
  {
    ...
    baseStats: { hull: 160, atk: 44, def: 59, spd: 25, foc: 30, res: 44 },
    growth: { hull: 14, atk: 4.3, def: 4.3, spd: 0.9, foc: 2.1, res: 2.8 },
  ...
  },
  {
    ...
    baseStats: { hull: 145, atk: 55, def: 55, spd: 26, foc: 34, res: 41 },
    growth: { hull: 13.2, atk: 5.2, def: 3.9, spd: 0.9, foc: 2, res: 2.4 },
  ...
  },
  {
    ...
    baseStats: { hull: 169, atk: 49, def: 67, spd: 25, foc: 32, res: 49 },
    growth: { hull: 15.5, atk: 4.7, def: 4.4, spd: 0.9, foc: 2.3, res: 3 },
  ...
  },
  {
    ...
    baseStats: { hull: 158, atk: 60, def: 61, spd: 28, foc: 39, res: 48 },
    growth: { hull: 14.4, atk: 5.5, def: 4.2, spd: 1, foc: 2.3, res: 3 },
  ...
  },
  {
    ...
    baseStats: { hull: 176, atk: 57, def: 68, spd: 26, foc: 38, res: 53 },
    growth: { hull: 16.1, atk: 5.5, def: 4.9, spd: 1, foc: 2.3, res: 3.2 },
  ...
  },
  {
    ...
    baseStats: { hull: 171, atk: 64, def: 61, spd: 29, foc: 43, res: 52 },
    growth: { hull: 15, atk: 6, def: 4.6, spd: 1.1, foc: 2.4, res: 3 },
